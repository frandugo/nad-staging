...
class Customize
{
    ...
    public function themeCustomizerAdditions($wp_customize)
    {
        ...
        $wp_customize->add_setting('endrock_base_theme_direccion', array(
            'type' => 'theme_mod',
            'capability' => 'edit_theme_options',
            'theme_supports' => '',
            'default' => '',
        ...
        $wp_customize->add_setting('endrock_base_theme_telefono', array(
            'type' => 'theme_mod',
            'capability' => 'edit_theme_options',
            'theme_supports' => '',
            'default' => '',
        ...
        /** Añadimos la opción para especificar la dirección */
        $wp_customize->add_control('endrock_base_theme_direccion', array(
            'type' => 'text',
            'priority' => 0,
            'section' => 'endrock_base_theme_contact_data',
            'label' => __('Address', 'endrock_base_theme'),
            'description' => __('Writte the company address', 'endrock_base_theme'),
            'input_attrs' => array(
        ...
        /** Añadimos la opción para especificar el teléfono */
        $wp_customize->add_control('endrock_base_theme_telefono', array(
            'type' => 'tel',
            'priority' => 1,
            'section' => 'endrock_base_theme_contact_data',
            'label' => __('Phone number', 'endrock_base_theme'),
            'description' => __('Writte the company phone number', 'endrock_base_theme'),
            'input_attrs' => array(
        ...
        $wp_customize->add_control('endrock_base_theme_email', array(
            ...
            'description' => __('Writte the company email', 'endrock_base_theme'),
            'input_attrs' => array(
        ...
        $wp_customize->add_control('endrock_base_theme_recaptcha_apikey', array(
            ...
            'description' => sprintf(__('Writte the api key obtained from google, to gat an API key go to <a href="%s" target="_blank" rel="no-follow">here</a>', 'endrock_base_theme'), 'https://g.co/recaptcha/v3'),
            'input_attrs' => array(
        ...
        $wp_customize->add_control('endrock_base_theme_recaptcha_secret', array(
            ...
            'description' => __('Writte the reCaptcha secret obtained from Google reCaptcha', 'endrock_base_theme'),
            'input_attrs' => array(
